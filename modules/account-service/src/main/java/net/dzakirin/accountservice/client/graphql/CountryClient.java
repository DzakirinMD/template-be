package net.dzakirin.accountservice.client.graphql;

import net.dzakirin.accountservice.dto.request.GraphqlRequestBody;
import net.dzakirin.accountservice.dto.response.CountryDto;
import net.dzakirin.accountservice.util.GraphqlSchemaReaderUtil;
